# Getting help with mlvizstats

Thanks for using mlvizstats. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/mlvizstats/issues) to make sure the 
